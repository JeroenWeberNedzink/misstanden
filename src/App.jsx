...
export default function App() {
    ...
    const checkAndRunMigrations = async () => {
      ...
      try {
        ...
        if (result.success) {
          ...
          setMigrationStatus('completed'); // Don't block app
  ...
  return (
    <Auth0Provider
      ...
      clientId={clientId}
      authorizationParams={{
        redirect_uri: window.location.origin, // ✅ NO /callback for IIS
        audience: `https://${domain}/mfa/`, // ✅ MFA audience for enrollment
        scope: 'openid profile email enroll read:authenticators remove:authenticators', // ✅ MFA scopes
      }}
