import{R as Ne,r as Rt}from"./vendor-Cl8b3JkH.js";function za(a,e){(e==null||e>a.length)&&(e=a.length);for(var t=0,r=Array(e);t<e;t++)r[t]=a[t];return r}function Ut(a){if(Array.isArray(a))return a}function Wt(a){if(Array.isArray(a))return za(a)}function Yt(a,e){if(!(a instanceof e))throw new TypeError("Cannot call a class as a function")}function Ht(a,e){for(var t=0;t<e.length;t++){var r=e[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(a,Ee(r.key),r)}}function Bt(a,e,t){return e&&Ht(a.prototype,e),Object.defineProperty(a,"prototype",{writable:!1}),a}function sa(a,e){var t=typeof Symbol<"u"&&a[Symbol.iterator]||a["@@iterator"];if(!t){if(Array.isArray(a)||(t=Ra(a))||e){t&&(a=t);var r=0,n=function(){};return{s:n,n:function(){return r>=a.length?{done:!0}:{done:!1,value:a[r++]}},e:function(l){throw l},f:n}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
